...
from onnxruntime import ExecutionMode, InferenceSession
...
class OrtInferSession:
    def __init__(
        ...
        if use_dml:
            EP_list.insert(0, ("DmlExecutionProvider", {"device_id": 0}))
        try:
    ...
    def _init_sess_opt(self):
        ...
        self.sess_opt.enable_mem_pattern = False
        self.sess_opt.execution_mode = ExecutionMode.ORT_SEQUENTIAL
